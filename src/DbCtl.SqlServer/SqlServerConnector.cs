...
[assembly: InternalsVisibleTo("DbCtl.SqlServer.Tests")]

namespace DbCtl.SqlServer
{
    [Export(typeof(IDbConnector))]
    [ExportMetadata("Name", "SqlServer")]
    [ExportMetadata("Description", "Database connector for Microsoft SQL Server")]
    ...
    public class SqlServerConnector : IDbConnector
    {
        ...
        internal SqlServerConnector(DbConnection dbConnection)
        {
