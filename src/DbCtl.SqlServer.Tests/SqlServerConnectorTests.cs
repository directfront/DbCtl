...
namespace DbCtl.SqlServer.UnitTests
{

    public abstract class SqlServerConnectorTestsBase : IDisposable
    {
        private const string DatabaseFileName = "DbCtl.SqlServer.UnitTest.db";
        protected string ConnectionString;
        protected SqliteConnection Connection;
        protected SqlServerConnector Connector;

        [SetUp]
        public virtual void Setup()
        {
            Connection = new SqliteConnection();
            Connector = new SqlServerConnector(Connection);
    ...
    [TestFixture]
    public class When_calling_create_change_log_table_on_sql_server_connector : SqlServerConnectorTestsBase
    {
        ...
        {
            var createTableTask = Connector.CreateChangeLogTableAsync(ConnectionString, _CancellationToken);
    ...
    [TestFixture]
    public class When_calling_add_change_log_entry_on_sql_server_connector : SqlServerConnectorTestsBase
    {
        private CancellationToken _CancellationToken = new CancellationToken();
        ...
        public async Task It_should_insert_the_change_log_entry()
        {
            ...
            var createTableTask = await Connector.AddChangeLogEntryAsync(ConnectionString, expectedEntry, _CancellationToken);
    ...
    [TestFixture]
    public class When_calling_fetch_change_log_entries_on_sql_server_connector : SqlServerConnectorTestsBase
    {
        private CancellationToken _CancellationToken = new CancellationToken();
