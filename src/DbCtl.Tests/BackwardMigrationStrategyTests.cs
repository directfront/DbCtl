...
{
    [TestFixture]
    public class When_calling_get_command_on_backward_migration_strategy
    {
        ...
        public void Setup()
        {
            ...
            _Strategy = new BackwardMigrationStrategy();
        }
        ...
        public void It_should_get_a_backward_migration_command()
        {
            ...
            Assert.AreEqual(MigrationType.Backward, ((MigrateCommand)command).Type);
        }
    }
}
